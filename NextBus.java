...
This program was written as a case study for Target Engineering position.
The program returns the time in minutes for a bus on "BUS ROUTE" leaving from "BUS STOP NAME" going "DIRECTION" using
the API at http://svc.metrotransit.org/
 */
...
public class NextBus {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //error checking direction to make sure we should continue
        if (directionID == -1) {
        ...
        //error checking stop to make sure we should continue
        if (stopID.equals("")) {
    ...
    private static void ComputeTime() {
        ...
        if (timeTillBus > 1) {
            ...
            System.out.println("Currently at station");
        } else {
     ...
     */
    private static int FetchInformation(String Url, String ElementOne, String ElementTwo, String compareString) {
        ...
        try {
            ...
            //element is the Json array containing the elements
